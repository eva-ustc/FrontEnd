    ...
    <div class="sj-content">
      <div class="left-nav">
        <div class="float-nav" id="float-nav">
          <ul class="sui-nav nav-tabs nav-xlarge tab-navbar tab-vertical">
            ...
            <li><a href="#">开发语言/框架</a></li>
            <li><a href="#">人工智能</a></li>
            <li><a href="#">云计算</a></li>
            <li><a href="#">移动开发</a></li>
            <li><a href="#">硬件/嵌入式开发</a></li>
          </ul>
        </div>
      </div>
      <div class="right-content">
        <div class="fl middle">
          ...
          &lt;!&ndash; <script src="~/assets/data-list.js" type="text/javascript"></script> &ndash;&gt;
        </div>
        <div class="fl right">
          <div class="activity">
            <div class="acti">
          ...
          <div class="ad-carousel">
            <div class="carousel">
              <div id="myCarousel2" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
                <ol class="carousel-indicators">
                  <li data-target="#myCarousel" data-slide-to="0" class="active"></li>
                  <li data-target="#myCarousel" data-slide-to="1"></li>
                  <li data-target="#myCarousel" data-slide-to="2"></li>
          ...
          &lt;!&ndash; <link rel="import" href=".~/assets/.~/assets/modules/ui-modules/footer/footer.html?__inline"> &ndash;&gt;
        </div>
      </div>
    </div>
  </div>-->
